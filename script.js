        ...
        'Basic': {
            ...
            features: [
                ...
                { icon: 'ph-television', label: 'OTT Apps', value: `<div style="display:flex;align-items:center;margin-top:6px;">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Zee5_logo.svg/512px-Zee5_logo.svg.png" alt="Zee5" title="Zee5" style="width:44px;height:44px;border-radius:14px;object-fit:cover;border:2px solid #222;background:#000;box-shadow:2px 2px 6px rgba(0,0,0,0.25);margin-right:-8px;position:relative;z-index:4;">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Hoichoi_logo.png/240px-Hoichoi_logo.png" alt="Hoichoi" title="Hoichoi" style="width:44px;height:44px;border-radius:14px;object-fit:cover;border:2px solid #c0392b;background:#e74c3c;box-shadow:2px 2px 6px rgba(0,0,0,0.25);margin-right:-8px;position:relative;z-index:3;">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/SonyLIV_logo.svg/512px-SonyLIV_logo.svg.png" alt="SonyLiv" title="Sony LIV" style="width:44px;height:44px;border-radius:14px;object-fit:cover;border:2px solid #111;background:#111;box-shadow:2px 2px 6px rgba(0,0,0,0.25);margin-right:-8px;position:relative;z-index:2;">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Jio_Hotstar_logo.svg/512px-Jio_Hotstar_logo.svg.png" alt="JioHotstar" title="JioHotstar" style="width:44px;height:44px;border-radius:14px;object-fit:cover;border:2px solid #6a0dad;background:linear-gradient(135deg,#7b2ff7,#3b0f8c);box-shadow:2px 2px 6px rgba(0,0,0,0.25);margin-right:4px;position:relative;z-index:1;">
                    <div title="More" style="width:44px;height:44px;border-radius:14px;background:#1a3c6e;color:#fff;font-size:1.4rem;font-weight:700;display:flex;align-items:center;justify-content:center;box-shadow:2px 2px 6px rgba(0,0,0,0.2);">+</div>
                </div>` },
